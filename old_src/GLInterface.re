...
[@bs.send] external bufferData : (context, int, TypedArray.typedarray, int) => unit = "bufferData";
...
[@bs.send] external cullFace : (context, int) => unit = "cullFace";
...
[@bs.send] external drawElements : (context, int, int, int, int) => unit = "drawElements";
[@bs.send] external enableVertexAttribArray : (context, attrib) => unit = "enableVertexAttribArray";
[@bs.send] external enable : (context, int) => unit = "enable";
...
[@bs.send] external uniformMatrix4fv : (context, uniform, bool, TypedArray.float32) => unit = "uniformMatrix4fv";
